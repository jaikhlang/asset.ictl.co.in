    ...
    <div class="row" style="padding-top: 20px;">
        ...
        <div class="col s12 m12">
          <div class="owl-carousel white" id="owl-carousel1">
            ...
            <div class="item" style=""><a href="{{ url('http://www.mrbpublishers.com') }}" target="_blank"><img src="{{ asset('image/sponsors/mrb.jpg') }}" alt=""></a></div>
            <div class="item" style=""><a href="{{ url('http://www.pearsoned.com') }}" target="_blank"><img src="{{ asset('image/sponsors/pearsonw.png') }}" alt=""></a></div>
            <div class="item" style=""><a href="{{ url('http://www.shankarsbook.com/') }}" target="_blank"><img src="{{ asset('image/sponsors/shankar.png') }}" alt=""></a></div>
            <div class="item" style=""><a href="{{ url('http://www.springer.com') }}" target="_blank"><img src="{{ asset('image/sponsors/springer.jpg') }}" alt=""></a></div>
            <div class="item" style=""><a href="{{ url('http://taylorandfrancis.com') }}" target="_blank"><img src="{{ asset('image/sponsors/taylor.jpg') }}" alt=""></a></div>
